...
const Product = () => {
  ...
  return (
    <div>
      ...
      <Modal isOpen={detailPopup !== null} onRequestClose={() => setDetailPopup(null)}>
        {detailPopup && <DetailPopUp handleClose={() => setDetailPopup(null)} data={detailPopup} />}
        {/* <DetailPopUp handleClose={setDetailPopup} data={data} /> */}
      </Modal>
    </div>
  )
}
